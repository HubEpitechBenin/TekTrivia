...
const MostAttemptQuizElement = ({title, image, attemptCount}) => {
  return (
    <div className="h-[19%] flex p-4 items-center justify-between border-b border-pm-blue300 dark:border-gray-500">
        <div>
            <p className="items-center">
                <span className="text-2xl text-pm-blue dark:text-gray-300">{image}</span>
            </p>
        </div>
        <div className="border-l-2 border-pm-blue300 dark:border-gray-500 pl-[7%]">
