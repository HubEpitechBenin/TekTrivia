    ...
    <div className={`absolute ${isActive ? '-left-1/2' : 'left-0'} w-1/2 h-full flex flex-col items-center justify-center text-gray-800 px-10 z-10 transition-all duration-700 ease-in-out`}>
        <form className="w-full flex flex-col justify-center items-center">
          ...
          <div className="relative w-full my-2">
            ...
            {/* <input type="text" placeholder="Username" required className="w-full p-3 bg-gray-200 rounded-lg outline-none text-base font-medium placeholder:text-gray-500" />*/}
          </div>
          ...
          <div className="relative w-full my-2">
            ...
            {/* <input type="password" placeholder="Password" required className="w-full p-3 bg-gray-200 rounded-lg outline-none text-base font-medium placeholder:text-gray-500" /> */}
          </div>
